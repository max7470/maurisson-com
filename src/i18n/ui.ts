...
export const BRISTOL_URL = 'https://bristol.maurisson.com';
...
export const ui = {
  fr: {
    ...
    'hub.bristol.title': 'Bristol',
    'hub.bristol.eyebrow': 'Le lecteur de fiches',
    'hub.bristol.body': 'Vos notes Word retrouvent le confort de la fiche cartonnée. Bristol lit un dossier de documents posé sur votre disque, cherche à l\'instant dans leur texte — pas seulement dans les titres — et pose celle que vous ouvrez sur un carton ivoire au format A6, que l\'on feuillette page après page, au doigt sur un écran tactile. Vos fichiers ne bougent pas et ne partent nulle part.',
    'hub.bristol.feat.1.title': 'Plein texte',
    'hub.bristol.feat.1.sub': 'Recherche dans le contenu',
    'hub.bristol.feat.2.title': 'Carton A6',
    'hub.bristol.feat.2.sub': 'Couleur et police au choix',
    'hub.bristol.feat.3.title': 'Chez vous',
    'hub.bristol.feat.3.sub': 'Rien ne quitte votre disque',
  ...
  nl: {
    ...
    'hub.bristol.title': 'Bristol',
    'hub.bristol.eyebrow': 'De fichelezer',
    'hub.bristol.body': 'Uw Word-notities krijgen het comfort van de kartonnen steekkaart terug. Bristol leest een map met documenten op uw eigen schijf, doorzoekt meteen hun tekst — niet alleen de titels — en legt de fiche die u opent op een ivoorkleurig kaartje op A6-formaat, dat u blad na blad doorbladert, met de vinger op een aanraakscherm. Uw bestanden blijven waar ze zijn en gaan nergens heen.',
    'hub.bristol.feat.1.title': 'Volledige tekst',
    'hub.bristol.feat.1.sub': 'Zoeken in de inhoud',
    'hub.bristol.feat.2.title': 'Kaartje op A6',
    'hub.bristol.feat.2.sub': 'Kleur en lettertype naar keuze',
    'hub.bristol.feat.3.title': 'Bij u thuis',
    'hub.bristol.feat.3.sub': 'Niets verlaat uw schijf',
  ...
  en: {
    ...
    'hub.bristol.title': 'Bristol',
    'hub.bristol.eyebrow': 'The index-card reader',
    'hub.bristol.body': 'Your Word notes get the comfort of a card index back. Bristol reads a folder of documents sitting on your own drive, searches their text instantly — not just the titles — and lays the one you open on an ivory A6 card you leaf through page by page, with your finger on a touch screen. Your files stay put and go nowhere.',
    'hub.bristol.feat.1.title': 'Full text',
    'hub.bristol.feat.1.sub': 'Search inside the content',
    'hub.bristol.feat.2.title': 'A6 card',
    'hub.bristol.feat.2.sub': 'Your colour, your typeface',
    'hub.bristol.feat.3.title': 'Stays home',
    'hub.bristol.feat.3.sub': 'Nothing leaves your drive',
  ...
  de: {
    ...
    'hub.bristol.title': 'Bristol',
    'hub.bristol.eyebrow': 'Der Karteikartenleser',
    'hub.bristol.body': 'Ihre Word-Notizen bekommen den Komfort der Karteikarte zurück. Bristol liest einen Ordner mit Dokumenten auf Ihrer eigenen Festplatte, durchsucht sofort deren Text — nicht nur die Titel — und legt die geöffnete Notiz auf eine elfenbeinfarbene Karte im A6-Format, die man Seite für Seite durchblättert, mit dem Finger auf einem Touchscreen. Ihre Dateien bleiben, wo sie sind, und gehen nirgendwohin.',
    'hub.bristol.feat.1.title': 'Volltext',
    'hub.bristol.feat.1.sub': 'Suche im Inhalt',
    'hub.bristol.feat.2.title': 'Karte in A6',
    'hub.bristol.feat.2.sub': 'Farbe und Schrift nach Wahl',
    'hub.bristol.feat.3.title': 'Bleibt bei Ihnen',
    'hub.bristol.feat.3.sub': 'Nichts verlässt Ihre Platte',
